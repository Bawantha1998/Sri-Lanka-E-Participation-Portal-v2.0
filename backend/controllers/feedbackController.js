...
const getFeedback = (req, res) => {
  ...
  const q =
    "SELECT *,tbl_feedback.created_at as ctime FROM tbl_feedback LEFT JOIN tbl_content ON tbl_content.content_id = tbl_feedback.content_id WHERE  tbl_content.content_url = ? and tbl_feedback.feedback_status = 1";
